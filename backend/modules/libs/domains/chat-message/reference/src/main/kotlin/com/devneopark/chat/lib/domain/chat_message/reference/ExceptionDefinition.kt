...
enum class ExceptionDefinition(
     ...
     * 멘션 시작 인덱스가 음수인 경우.
     */
    INVALID_MENTION_START_INDEX_NUMBER("1-005-003", "Mention start index is invalid."),

    /**
     * 멘션 종료 인덱스가 음수인 경우.
     */
    INVALID_MENTION_END_INDEX_NUMBER("1-005-004", "Mention end index is invalid."),

    /**
     * 멘션 시작 인덱스가 종료 인덱스보다 크거나 같은 경우 또는
     * 멘션 범위가 메시지 본문을 벗어난 경우.
     */
    INVALID_MENTION_RANGE("1-005-005", "Mention range is invalid."),

    /**
     * 하나의 메시지 본문에서 둘 이상의 멘션 범위가 겹치는 경우.
     */
    OVERLAPPING_MENTION_RANGES("1-005-006", "Mention ranges must not overlap."),
     ...
     */
    SELF_REPLY_NOT_ALLOWED("1-005-008", "Chat message cannot reply to itself."),
